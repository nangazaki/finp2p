$(function() {
	...
	new ApexCharts(document.querySelector("#chart5"), e).render(), Highcharts.chart("chart6", {
		...
		title: {
			text: "Eventos suspeitos  por Categoria , Março-2023"
		},
		accessibility: {
			announceNewData: {
				enabled: !0
		...
		series: [{
			...
			data: [{
				...
				y: 40.57,
				drilldown: "Proteção de Dados"
			}, {
				name: "Segurança na Cloud",
				y: 25.23,
				drilldown: "Cloud"
			}, {
				name: "Segurança Aplicacional",
				y: 10.58,
				drilldown: "Aplicacional"
			}]
		}],
		drilldown: {
			series: [{
		...
		title: {
			text: "Eventos Identificados por categoria"
		},
		xAxis: {
			categories: ["Malware", " Phishing", "Negação De Serviço", "Injeção de Codigo", "Engenharia reversa "]
		},
		yAxis: {
			min: 0,
			title: {
	...
	e = {
		...
		labels: ["Firewall", "Sistemas de detecção de intrusão", "Monitoramento de segurança", "Analise de Logs", "Antivírus"],
		fill: {
			opacity: 1
		},
		stroke: {
